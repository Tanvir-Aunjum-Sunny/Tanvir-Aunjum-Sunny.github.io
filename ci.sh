...
git remote set-url origin https://github.com/Tanvir-Aunjum-Sunny/Tanvir-Aunjum-Sunny.github.io.git
...
git push --all -f https://github.com/Tanvir-Aunjum-Sunny/Tanvir-Aunjum-Sunny.github.io.git